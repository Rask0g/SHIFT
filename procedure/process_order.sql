...
begin
    ...
    for i in 1..cardinality(p_order_info.order_items) loop
        ...
        v_cur_discount = 0;
        call get_discount_on_product(v_product_id, v_cur_discount);
